...
import Snake_Ladder from "../assets/graphics/NOT MY ANIMATION.json";
import {
  CalendarIcon,
  ClockIcon,
  MapPinIcon,
            ...
            <div className="space-y-5 text-gray-200 text-sm sm:text-base">
              ...
              <div>
                ...
                <p className="leading-relaxed">
                  Word Drawing Challenge, Quiz, Action.
                </p>
              </div>
            </div>
          </GlassCard>
          ...
          >
            <div className="space-y-5 sm:space-y-6 text-gray-200 text-sm sm:text-base">
              {[
                ...
                [MapPinIcon, "Venue", "3rd Year IT Classroom"],
