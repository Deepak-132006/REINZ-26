...
import Frontend from "../assets/graphics/Developer Presentation.json";
import {
  CalendarIcon,
  ClockIcon,
  MapPinIcon,
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-10 w-full max-w-7xl">
          ...
          >
            <p className="text-gray-200 text-sm sm:text-base leading-relaxed">
              A UI Event occurs when a user interacts with an on-screen or
              selecting sn option. The Interface responds instantly with visual
              feedback like highlights or animation. This Reaction confirms the
              action and guides th user to the next step UI Events ensure
              smooth, intuitive and responsive digital experiences.
            </p>
          </GlassCard>
          ...
          >
            <ul className="text-gray-200 text-sm sm:text-base space-y-2.5 list-disc list-inside marker:text-purple-400">
              <li>Time Max: 30 minutes</li>
              <li>Team: Max 2 members</li>
              <li>Tools: Any UI Tools</li>
              <li>Zero Code Policy</li>
              <li>Only 5 - 7 Prompts are Allowed</li>
            </ul>
          </GlassCard>
  ...
  <div className="space-y-6 text-gray-200 text-sm sm:text-base">
    ...
    <div>
      ...
      <ul className="list-disc list-inside marker:text-purple-400 space-y-1.5">
        <li>Ms. S.M.Nivetha (AP/IT)</li>
      </ul>
    </div>

    {/* Bottom judge – with separator */}
    <div className="pt-5 border-t border-white/10">
      <p className="font-semibold text-purple-300 mb-1.5">Staff Coordinator</p>
      <ul className="list-disc list-inside marker:text-purple-400 space-y-1.5">
        <li>Ms. S.M.Nivetha (AP/IT)</li>  {/* ← Add second judge here */}
      </ul>
    </div>
  </div>
</GlassCard>
          ...
          >
            <div className="space-y-5 text-gray-200 text-sm sm:text-base">
              <div>
                <p className="font-semibold text-purple-300">Student Coordinator</p>
                <p>Afra Fathima</p>
              </div>
              <div>
